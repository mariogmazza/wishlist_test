      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormItem {...tailFormItemLayout}>
          {getFieldDecorator('agreement', {
            ...
            <Checkbox>Sign me up for exclusive newsletter deals </Checkbox>
          )}
        </FormItem>
        <FormItem {...tailFormItemLayout}>
        <button className="button button-cart btn centerBTN login-form-button" htmlType="submit"  id="button-cart" data-loading-text="Loading...">
...
class Checkout extends React.Component {
  render() {
    ...
    <h2 style={{textAlign: 'center'}}> Guest Customers</h2>
...
<h4 style={{textAlign: 'center'}}>Continue to checkout without signing in. You will have the opportunity to register later.</h4>
    </Grid.Column>
    </Grid>
          </div>
      </Container>
